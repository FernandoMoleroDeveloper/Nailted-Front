...
const Results = (): JSX.Element => {
  ...
  return (
    <div className="results-page page">
      ...
      <Flex className="results-page__container" flexDirection="column">
        ...
        <Box display="flex" flexWrap="wrap">
          <Box display="flex" justifyContent="space-between" marginTop="20px">
            <Box width="40%" maxWidth="120px" display="flex" alignItems="center">
        ...
        <FormHelperText marginTop="40px" fontWeight={400}>Be better, my friend!</FormHelperText>
      </Flex>
