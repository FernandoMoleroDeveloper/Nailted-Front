  ...
  return (
    <div className="header">
      ...
      <Box display="flex" flexDirection="column" alignItems="start" m="15">
        <Textarea margin="0 auto" maxWidth="800px" height="200px" size="md" alignItems="center" textAlign="start" placeholder="Escribe aquí..." borderBottomColor="#0069D9" borderLeft="none" borderRadius="0" borderRight="none" borderTop="none" value={text} onChange={handleTextChange} />
      </Box>
